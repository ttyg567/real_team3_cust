...
<!-- End.main_haeder -->
  ...
  <div id="content">
    ...
    <section class="page_news">
      <div class="emBlock__border padding-l-0 bg-snow" style="width: 100%;
      overflow-x: auto; padding-left: 5px;
      scrollbar-width: none; -ms-overflow-style: none;">
        <ul class="nav navListProducts" style="display: inline-flex; width: max-content;">
