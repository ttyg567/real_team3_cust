...
<header class="main_haeder header-sticky multi_item header-white">
    ...
    <div class="em_side_right">
        ...
        <c:choose>
            <c:when test="${logincust == null}">
                <a href="/cust/login" class="btn justify-content-center">
                    <svg class="ico color-secondary" id="Iconly_Two-tone_Bookmark" data-name="Iconly/Two-tone/Bookmark"
                        ...
                        <%--  커서 올리면 교체될 나의조인 아이콘   --%>
                    <svg class="hover_ico color-primary" id="Iconly_Two-tone_Bookmark"
            ...
            <c:otherwise>
                <a href="/groupboard/my_applyjoin?custNo=${logincust.custNo}"
                   class="btn justify-content-center relative color_svg">
                    <svg class="ico color-secondary" id="Iconly_Two-tone_Bookmark" data-name="Iconly/Two-tone/Bookmark"
                         xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <g id="Bookmark" transform="translate(3.5 2)">
                            <path id="Path_33968"
        ...
        <a href="/notification" class="btn justify-content-center relative color_svg">
            ...
            <svg class="hover_ico color-primary" id="Iconly_Two-tone_Notification"
...
<section class="banner__wallet" style="height: 100%;">
    <div class="emhead d-flex align-items-center justify-content-between">
        <div class="item__total">
            <span style="color: white">헬쓱회원이 조인으로 할인받은 금액</span>
            <h2 id="status1" countTo="1765000">1,765,000 <span>원</span></h2>
        </div>
...
<main class="main_Wallet_index">
    <section class="em__bkOperationsWallet npSwiper__ads bg-white np_Package_ac padding-t-0 mt-0 padding-b-0"
    ...
    <section class="banner_swiper npSwiper__ads bg-white np_Package_ac padding-t-0 mt-0 padding-b-0">
        <div>
            <p class="size-14 color-black m-0 pt-1"
               style="font-weight: bold; padding-left: 10px; padding-bottom: 5px;">${logincust.custName}님 맞춤 추천 조인🌟</p>
        </div>
        <div class="title d-flex justify-content-between align-items-center padding-l-20 padding-r-20">
            <div style="width: 230px">
                <span class="size-16 weight-100 color-secondary m-0">나의 관심지역<a class="nav-link" href="/cust/information"
                                                                               style="display: inline-block; width: 50%; margin: 0; padding-right: 0px; padding-left: 8px">${logincust.custSigungu}<i
                        class="tio-chevron_down -arrwo"></i></a></span>
                        ...
                        <div class="item em_item_product" style="width: 162px">
                            <div class="em_head" id="join_em_head1"><!-- 선택 시 센터 상세페이지로 이동 -->
                                <a data-toggle="modal"
                                   ...
                                   class="image_product text-decoration-none">
                                    <div class="join_image_bg"
                                         style="background-image: url('/assets/img/${obj.groupboardImgname}');"></div>
                                </a>
                                <c:set var="joinDiscount" value="${obj.ticketDiscount + 10}"/>
                                <div id="join_discount" class="item_discount"><fmt:formatNumber
                                        value="${joinDiscount}"/>%
                                </div>
                            </div>
                            <div class="title_product">
                                <div class="color-black">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
                                         class="bi bi-geo-alt color-text" viewBox="0 0 16 16">
                                    ...
                                    <div class="main_joincontent" style="text-align: left">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                             fill="currentColor" class="bi bi-ticket-perforated color-text"
                                             viewBox="0 0 16 16">
                                ...
                                <div class="card_user color-text">
                                    ...
                                    <span style="font-size: smaller; color: #5d6072; font-weight: bold "><fmt:formatNumber
                                            value="${canapplymember}"/>명 조인 시 </span>
        ...
        <div class="title d-flex justify-content-between align-items-center padding-l-20 padding-r-20">
            ...
            <span class="size-16 weight-100 color-secondary m-0">나의 선호운동
                <a class="nav-link" href="/cust/information"
                   style="display: inline-block; width: 50%; margin: 0; padding-right: 0px; padding-left: 8px">
