...
<div id="wrapper">
    ...
    <header class="main_haeder header-sticky multi_item header-white">
        ...
        <div class="em_side_right">
            ...
            <a href="/notification?custNo=${logincust.custNo}" class="btn justify-content-center relative color_svg">
                <svg class="ico color-secondary" id="Iconly_Two-tone_Notification"
    ...
    <section class="np__bkOperationsService padding-0" style="width: 100%; padding-bottom: 0;
      ...
      scrollbar-width: none; -ms-overflow-style: none;">
        ...
        <div class="em__actions"
             style="display: inline-flex; width: max-content; margin-top: 5px; margin-bottom: 10px; ">
    ...
    <div class="title d-flex justify-content-between align-items-center padding-l-20 padding-r-20">
        <c:choose>
            ...
            <c:when test="${my_ticket_list == '[]'}">
                <div>
                    <h3 class="size-16 weight-500 color-secondary m-0">${logincust.custName}님, 운동센터를 아직 고민
                        중이신가요?<br><br>
                        <p class="size-12 m-0 pt-1" style="color: blueviolet; font-weight: bold">현재 위치 주변 헬쓱센터를 검색하고<br>
                            합리적인 가격으로 운동 이용권을 구매해 보세요!</p>
                </div>
            </c:when>
            <c:otherwise>
                <div>
                    <h3 class="size-17 weight-500 color-secondary m-0">${logincust.custName}님의 KB피트니스센터 본관 여의도점<br>
                        <h3 class="size-17 weight-500 color-secondary m-0"><span
                                style="color: limegreen; font-weight: bold; font-size: 18px">혼잡도는 지금 맑음</span> 이에요</h3>
    ...
    <section class=" components_page padding-b-30">
        ...
        <c:choose>
            <c:when test="${logincust == null || my_ticket_list == '[]'}">
                <div class="map_wrap">
                    <div id="map" style="width:100%;height:100%;position:relative;overflow:hidden;"></div>
                    <div id="menu_wrap" class="bg_white">
                        <div class="option">
                            <div>
                                <form onsubmit="searchPlaces(); return false;" class="search-form">
                                    <input type="text" value="성수" id="keyword" class="search-input" size="15">
                                    <button type="submit" class="search-button">검색</button>
                                    <div onclick="getCurrentLocation()">
                                        <img src="/assets/img/candy/tool.png" id="locationicon" alt="chatbot" style="width: 25px; height: 25px; color: darkgrey">
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="pt_simpleDetails m-0 py-2 rounded-0 emBlock__border">
                    <div class="em_bodyinner">
                        <div class="embkRateCustomer">
                                ...
                                <div class="row" style="height: 160px">
                                    <div class="col-4" style="height: 150px; padding-right: 0px">
                                        <img src="/img/good.png" alt=""
                                             style="height: 90%; padding-bottom: 15px; padding-top: 15px;">
                                    </div>
                                    <div class="col-8" style="height: 150px">
                                        ...
                                        <div class="btn btn_smView d-flex align-items-center" data-toggle="tooltip"
                                            ...
                                            <span class="size-13 color-black m-0 pt-1"
                                                  style="font-weight: bold; padding-right: 5px; text-align: left; padding-left: 0px; flex: 1;">나의 운동기구함</span>
                                        ...
                                        <div class="progress__rate">
                                            <div class="">
                                                <c:forEach var="obj" items="${myMachine}">
                                                    <c:set var="canQuantity"
                                                           value="${canQuantity = (obj.holdingQuantity - obj.usingQuantity) }"/>
                                                    <input type="hidden" name="holdingQuantity"
                                                           value="${obj.holdingQuantity}"/>
                                                    <input type="hidden" name="usingQuantity"
                                                           value="${obj.usingQuantity}"/>
                                                    <div class="item"
                                                            ...
                                                            <c:choose>
                                                                    ...
                                                                    <div style="display: flex; align-items: center; justify-content: space-between;">
                                                                        <div class="progress" style="height: 8px;">
                                                                            <div class="progress-bar" role="progressbar"
                                                                                 style="width: 100%; background-color: #ff8000;"
                                                                        ...
                                                                        <a href="/removemymachine?machineNo=${obj.machineNo}">
                                                                            <i class="ri-close-fill color-text"
                                                                ...
                                                                <c:when test="${canQuantity <= 2}">
                                                                    <div style="display: flex; align-items: center; justify-content: space-between;">
                                                                        <div class="progress" style="height: 8px;">
                                                                            <div class="progress-bar" role="progressbar"
                                                                                 style="width: 60%; background-color: #1E90FF;"
                                                                                 aria-valuenow="70" aria-valuemin="0"
                                                                                 aria-valuemax="100">
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <c:otherwise>
                                                                    <div style="display: flex; align-items: center; justify-content: space-between;">
                                                                        <div class="progress" style="height: 8px;">
                                                                            <div class="progress-bar" role="progressbar"
                                                                                 style="width: 20%; background-color: #32CD32;"
                                                                                 aria-valuenow="70" aria-valuemin="0"
                                                                                 aria-valuemax="100">
                                                                            </div>
                                                                        </div>
                            ...
                            <%-- 센터가 보유한 운동기구 나열 --%>
                        <p class="size-14 color-black m-0 pt-1" style="font-weight: bold; padding-bottom: 10px">이용이 가능한
                            운동기구</p>
                            <%-- 검색 버튼 --%>
                            ...
                            <div class="d-flex justify-content-start">
                                <a href="/">
                                    <button type="button" class="btn btn-outline-secondary"
                                            style="border-radius: 15px; font-size: 9px; width: 45px; height: 33px; margin-right: 5px;">
                                        전체
                                    </button>
                                </a>
                                <button type="button" class="btn btn-outline-secondary"
                                        ...
                                        style="border-radius: 15px; font-size: 9px; margin-right: 5px;">시간대별 <i
                                        class="tio-chevron_down -arrwo"></i>
                                </button>
                                <button type="button" class="btn btn-outline-secondary"
                                        data-toggle="modal"
                                        data-target="#mdllFilter"
                                        style="border-radius: 15px; font-size: 9px; margin-right: 5px;">부위별 <i
                                        class="tio-chevron_down -arrwo"></i>
                                </button>
                            </div>
                            <div></div>
                        ...
                        <br>
                        <p class="size-14 color-black m-0 pt-1" style="font-weight: bold; padding-bottom: 10px">기구
                            검색결과</p>
                                    ...
                                    <div class="itemPkg_cart" data-toggle="modal"
                                        ...
                                        <div class="sideleft" style="height: 60px">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${canQuantity == 0}">
                                                            <div class="itemCircle"
                                                                 style="height: 60px; padding-right: 15px; padding-top: 0px">
                                                                <input type="image" data-width="60" value="100"
                                                                       data-fgColor="#ff8000"
                                                                       data-bgColor="#E9EAEC" data-thickness=".15"
                                                                       class="circleFull"
                                                                       src="/img/${obj.machineImgname}"
                                                        ...
                                                        <c:when test="${canQuantity <= 2}">
                                                            <div class="itemCircle"
                                                                 style="height: 60px; padding-right: 15px; padding-top: 0px">
                                                                <input type="image" data-width="60" value="60"
                                                                       data-fgColor="#1E90FF"
                                                                       data-bgColor="#E9EAEC" data-thickness=".15"
                                                                       class="circleFull"
                                                                       src="/img/${obj.machineImgname}"
                                                        ...
                                                        <c:otherwise>
                                                            <div class="itemCircle"
                                                                 style="height: 60px; padding-right: 15px; padding-top: 0px">
                                                                <input type="image" data-width="60" value="20"
                                                                       data-fgColor="#32CD32"
                                                                       data-bgColor="#E9EAEC" data-thickness=".15"
                                                                       class="circleFull"
                                                                       src="/img/${obj.machineImgname}"
                                            ...
                                            <div>
                                                                    ...
                                                                    <c:choose>
                                                                        <c:when test="${canQuantity == 0}">
                                                                            <span class="number_item"
                                                                                  style="margin-left: 6px">혼잡</span>
                                                                        </c:when>
                                                                        <c:when test="${canQuantity <= 2}">
                                                                            <span class="number_item"
                                                                                  style="margin-left: 6px; color: blue; border: 1px solid blue;">보통</span>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <span class="number_item"
                                                                                  style="margin-left: 6px; color: limegreen; border: 1px solid limegreen;">여유</span>
                                                                        </c:otherwise>
                                                                    </c:choose>
                                                ...
                                                <c:set var="canQuantity"
                                                       value="${canQuantity = (obj.holdingQuantity - obj.usingQuantity) }"/>
                                                <span style="font-size: 12px; font-weight: bold"><fmt:formatNumber
                                                        value="${canQuantity}"/>대 남음</span>
                    ...
                    <div class="modal-body padding-b-100">
                        <div class="em_box_content_filter">
                            ...
                            <div class="buttons_select">
                                <div class="items">
                                    <div class="btn-group" role="group"
                                        ...
                                        <input type="checkbox" class="btn-check" id="btncheck1" value="1"
                                               autocomplete="off" name="exerciseType" style="display: none;"
                                        <c:if test="${ms.exerciseType == '1'}"></c:if>>
                                        <label class="btn btn-outline-primary" for="btncheck1">등</label>

                                        <input type="checkbox" class="btn-check" id="btncheck2" value="1"
                                               autocomplete="off" name="exerciseType" style="display: none;"
                                        <c:if test="${ms.exerciseType == '1'}"></c:if>>
                                        <label class="btn btn-outline-primary" for="btncheck2">어깨</label>

                                        <input type="checkbox" class="btn-check" id="btncheck3" value="1"
                                               autocomplete="off" name="exerciseType" style="display: none;"
                                        <c:if test="${ms.exerciseType == '1'}"></c:if>>
                            ...
                            <div class="buttons_select">
                                <div class="items">
                                    <div class="btn-group" role="group"
                                         name="exerciseType"
                                         aria-label="Basic checkbox toggle button group">
                                        <input type="checkbox" class="btn-check" id="btncheck4" value="2"
                                               autocomplete="off" name="exerciseType" style="display: none;"
                                        <c:if test="${ms.exerciseType == '2'}"></c:if>>
                                        <label class="btn btn-outline-primary" for="btncheck4">허벅지</label>

                                        <input type="checkbox" class="btn-check" id="btncheck5" value="2"
                                               autocomplete="off" name="exerciseType" style="display: none;"
                                        <c:if test="${ms.exerciseType == '2'}"></c:if>>
                                        <label class="btn btn-outline-primary" for="btncheck5">종아리</label>

                                        <input type="checkbox" class="btn-check" id="btncheck6" value="2"
                                               autocomplete="off" name="exerciseType" style="display: none;"
                                        <c:if test="${ms.exerciseType == '2'}"></c:if>>
                            ...
                            <div class="emPatternSizes">
                                <div class="box_sizes justify-content-center"
                                     style="display: flex; flex-direction: column;">
                                    <div class="item" style="width: 200px; border-radius: 10px; margin-bottom: 5px">오전
                                        7시 ~ 오전 9시
                                    </div>
                                    <div class="item selected"
                                         style="width: 200px; border-radius: 10px; margin-bottom: 5px">오전 10시 ~ 오후 1시
                                    </div>
                                    <div class="item" style="width: 200px; border-radius: 10px; margin-bottom: 5px">오후
                                        2시 ~ 오후 5시
                                    </div>
                                    <div class="item" style="width: 200px; border-radius: 10px; margin-bottom: 5px">오후
                                        6시 ~ 오후 9시
    ...
    <c:forEach var="obj" items="${gymAllMachine}">
        <form name="machine_form" id="machine_form" action="/addmymachine" method="get">
            ...
            <input type="hidden" name="gymNo" value="${obj.gymNo}"/>
            <input type="hidden" name="myMachineStatus" value="1"/>
            <div class="modal defaultModal modalCentered change__address fade" id="mdllAdd_Address${obj.machineNo}"
                 tabindex="-1"
                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <ul class="nav__listAddress itemSingle"
                                ...
                                <p class="size-12 color-text" style="text-align: center;">
                                    <span style="color: black">인기시간대 <span
                                            style="color: blueviolet; font-weight: bold; font-size: 14px;">오후 6시 23분🌟</span></span><br>
                                    <span style="color: black">평균 이용회원이 지난 주보다</span> <span
                                        style="color: blueviolet; font-weight: bold;  font-size: 14px;">2.6명 ↑</span><br>
                                    <span style="color: black">보통 이 기구에서 회원들이</span> <span
                                        style="color: blueviolet; font-weight: bold;  font-size: 14px;">${obj.usingTime} 머물러요</span>
                                </p><br>
                                <li class="item selected">
                                    <div class="personal__info">
                                        <div class="areaRight">
                                            <span class="circle_check"
                                                  style="width: 15px; height: 15px; margin-right: 5px;"></span>
                                            <p class="size-15 color-secondary weight-400">기구 사용 Tip</p>
                                        </div>
                                        <p class="size-11 color-text weight-400">등 근육을 키울 때 매우 적합한 운동으로,<br> 손잡이의 너비를
                                            조절해가며 다양한 운동부위를 타깃으로 정할 수 있어요!</p>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn_default_lg"
                                    ...
                                    data-dismiss="modal" aria-label="Close">확인
                            </button>
        ...
        <div class="modal defaultModal modalCentered change__address fade" id="mdllAdd_Address" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header border-0 padding-l-20 padding-r-20 justify-content-center">
                        <div class="itemProduct_sm">
                            <h1 class="size-18 weight-500 color-secondary m-0">실시간 스마트 정보</h1>
                        </div>

                    </div>
                    <div class="modal-body" style="height: 400px;">
                        <ul class="nav__listAddress itemSingle"
                            style="height: 150px; display: flex; align-items: center; flex-direction: column;">
                                <%-- 운동센터명  --%>
                            ...
                            <div style="border-radius: 5px; background-color: red;
                                ...
                                <p style="color: white; font-weight: bold; font-size: 14px; text-align: center;">
                                    TODAY</p>
                            </div>
                            <span style="color: blueviolet; font-weight: bold;
                                    font-size: 14px; padding-top: 5px;">회원 수가 가장 많은 금요일🌟</span><br>
                            <span style="color: black; font-weight: bold; font-size: 14px;">오늘은 "등" 운동기구를 많이 이용해요!</span><br>
                            </p><br>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body" style="height: 260px;">
                    <ul class="nav__listAddress itemSingle"
                        style="height: 50px; display: flex; align-items: center; flex-direction: column;">
                            <%-- 운동센터명  --%>
                        <p style="font-size: 15px; font-weight: bold">오늘 찜한 그 이용권,<br> 함께 구매하면 <span
                                style="font-size: 15px; font-weight: bold; color: blueviolet">15% 할인</span> 받아요!</p>
                    ...
                    <ul class="itemList__news"
                        style="padding-left: 0; padding-right: 0; padding-top: 5px; padding-bottom: 20px">
                            <%--  li : 화면에 보여질 조인들   --%>
                        <li class="items-nav">
                            <a class="btn" href="">
                                <div class="media align-items-center">
                                        <%--1.찜한 센터 이용권의 이미지--%><img class="img_news"
                                                                     src="/assets/img/gymImg/${obj.gymImgName}" alt="">
                                            ...
                                            <div class="info_bottom">
                                                <div class="time">
                                                    <div class="icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                                             fill="currentColor"
                                                             class="bi bi-ticket-perforated color-text"
                                                             viewBox="0 0 16 16">
                                                        ...
                                                        <%-- 이용권명 --%>
                                                    <span style="color: black; font-size: 11px; font-weight: bold">${obj.gymName}<span
                                                            style="color: gray"></span><br> ${obj.ticketName}</span>
                                                </div>
                                            </div>
                                            <div class="info_bottom">
                                                <div class="time">
                                                    <div class="icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                             fill="currentColor" class="bi bi-coin color-primary"
                                                             viewBox="0 0 16 16">
                                                    ...
                                                    <span style="color: black;font-weight: bold; font-size: 11px">일반 회원가 <fmt:formatNumber
                                                            value="${obj.ticketCost}" pattern="###,### 원"/></span>
                                                </div>
                                            </div>
                        ...
                        <p style=" text-align: center; font-size: 12px; font-weight: bold; color: black">
                            다른회원과 ${obj.gymName} 이용권을 <br>
                            <span style="color: blueviolet; font-size: 15px; font-weight: bold"><fmt:formatNumber
                                    value="425000" pattern="###,### 원"/>으로</span><br>
...
<script>
    ...
    function showPosition(position) {
        ...
        geocoder.coord2Address(coords.getLng(), coords.getLat(), function (result, status) {
            if (status === kakao.maps.services.Status.OK) {
                ...
                var dong = extractDong(address);
                keywordInput.value = dong;
            }
        });
    }
    ...
    function extractDong(address) {
        ...
        if (startIndex !== -1) {
            var endIndex = address.indexOf(" ", startIndex + 1);
            if (endIndex !== -1) {
                dong = address.substring(startIndex + 1, endIndex);
            }
        }
        return dong;
    }
