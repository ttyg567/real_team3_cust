      ...
      <div class="em_bodyinner">
        <div class="emCommentCusomers">
          ...
          <div class="padding-t-100">
            ...
            <div class="em_footerinner" style="margin-bottom: 50px; position: fixed; z-index:9999; bottom: 65px">
              <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" style="width: 90%">
