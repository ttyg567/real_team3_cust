        ...
        <c:forEach var="detailImg" items="${gdetail_detail_img}">
            <div class="cover">
                <img class="item_img_detail" src="/assets/img/gymImg/${detailImg}" alt="${detailImg}"
                     style="width: 90%; margin-left: 5vw; margin-top: 70px">
                                    ...
                                    <c:forEach var="ticket" items="${tickets}">
                                        ...
                                        <span class="bottom">
                                            ...
                                            <span class="price" style="margin-right: 3vw; color: purple">
                                                <fmt:formatNumber value="${ticket.ticketPrice}" type="number" pattern="#,##0 원" />
                                            </span>
                                        </span>
                        ...
                        <a href="page-news-details.html" class="btn">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    <div class="txt">
                                        <h2 style="color: rebeccapurple; margin-bottom: -20px"> 강사 ${obj.trainerName}</h2>
