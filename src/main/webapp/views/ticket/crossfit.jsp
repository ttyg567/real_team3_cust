                ...
                <div class="em__actions">
                    <ul class="nav navListProducts" style="display: inline-flex; width: max-content; margin-top: 5px">
                        <li class="nav-item" style="padding-left: 15px;"><!-- 진한 글씨로 표기된 페이지 active '전체' -->
                            <a class="nav-link" href="/ticket/all" style="padding-right: 7px;" >
...
">
                ...
                box-shadow: 0 8px 6px -5px rgba(0, 0, 0, 0.2), 4px 4px 3px -3px rgba(0, 0, 0, 0.1);">
                                ...
                                <p style="color: gray; font-size: 12px; width: 50px; text-align: center; padding-top: 5px;">헬스</p>
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                box-shadow: 0 8px 6px -5px rgba(0, 0, 0, 0.2), 4px 4px 3px -3px rgba(0, 0, 0, 0.1);">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="/ticket/crossfit"  style="padding-right: 7px;">
                                <div class="icon bg-opacity-10">
...
">
                                ...
                                <p style="font-weight: bold; color: blueviolet; font-size: 12px; width: 50px; text-align: center; padding-top: 3px;">크로스핏</p>
