            ...
            <c:when test="${couponOpen.couponName == '할인권'}">
                <section class="emPage__ResultPayment">
                    <div class="em__seccess">
                        <h2 class="size-20 weight-500 color-secondary margin-b-10">축하드려요! 조인 완료하셨어요!</h2>
                        <h2 class="size-20 weight-500 color-secondary margin-b-10">이용권을 바로 구매하세요</h2>
                        <p class="size-15 color-text margin-b-10 moving-text">▼ ${couponOpen.gymName} ${couponOpen.ticketName} ▼</p>
